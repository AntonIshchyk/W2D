...
public class UserActivitiesController : ControllerBase
{
    ...
    public async Task<ActionResult<UserActivity>> ScheduleActivity(ScheduleActivityRequest request)
    {
        ...
        var existingUserActivity = await _userActivityService.GetExistingUserActivityAsync(userId, request.ActivityId, request.PlannedDate);
        if (existingUserActivity != null)
        {
            return BadRequest(new { message = "You have already scheduled this activity for this date" });
        }

        var userActivity = await _userActivityService.ScheduleActivityAsync(
            userId,
            request.ActivityId,
            request.PlannedDate,
            request.Notes
    ...
    public async Task<ActionResult<IEnumerable<UserActivity>>> GetPlannedActivities()
    {
        ...
        var userActivities = await _userActivityService.GetUserScheduledActivitiesAsync(userId);
    ...
    public async Task<ActionResult<IEnumerable<UserActivity>>> GetCompletedActivities()
    {
        ...
        var userActivities = await _userActivityService.GetUserCompletedActivitiesAsync(userId);
    ...
    public async Task<ActionResult<IEnumerable<UserActivity>>> GetHistory()
    {
        ...
        var userActivities = await _userActivityService.GetUserHistoryAsync(userId);
    ...
    public async Task<ActionResult<UserActivity>> GetUserActivity(int id)
    {
        ...
        var userActivity = await _userActivityService.GetUserActivityByIdAsync(id, userId);
    ...
    public async Task<ActionResult<UserActivity>> CompleteActivity(int id, [FromBody] CompleteActivityRequest? request = null)
    {
        ...
        var userActivity = await _userActivityService.MarkAsCompletedAsync(id, userId, request?.CompletedDate);
    ...
    public async Task<ActionResult<UserActivity>> CancelActivity(int id)
    {
        ...
        var userActivity = await _userActivityService.CancelUserActivityAsync(id, userId);
    ...
    public async Task<ActionResult> DeleteUserActivity(int id)
    {
        ...
        var deleted = await _userActivityService.DeleteUserActivityAsync(id, userId);
